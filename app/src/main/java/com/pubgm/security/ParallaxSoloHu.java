...
/** Per-install non-exportable Android Keystore identity. */
@Obfuscate
public final class ParallaxSoloHu {
    private static final String ANDROID_KEY_STORE = "AndroidKeyStore";
    private static final String KEY_ALIAS = "parallax.javaloader.device.ec.v2";

    private ParallaxSoloHu() {
    }
