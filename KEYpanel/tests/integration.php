...
$payload = json_encode([
    ...
    'timestamp' => time(),
    'version_code' => 1,
    'package_name' => 'OneCore.Vip',
    'certificate_sha256' => 'B343111BBFA30ED565F9B61A52CF5B34CB2EAF0485EB8B396AB373B2ECCA53D4',
], JSON_THROW_ON_ERROR);
...
echo "OneCore MyThos MySQL integration passed ($assertions assertions).\n";
