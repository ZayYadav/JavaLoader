...
if ($temporary === false) throw new \RuntimeException('Could not create test file.');
...
$assert(!str_contains((string) $schema, 'TABLE IF NOT EXISTS device_license_bindings'), 'Separate device bindings must not be installed.');
...
echo "OneCore MyThos panel tests passed ($assertions assertions).\n";
