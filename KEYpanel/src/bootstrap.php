...
$sessionName = Env::get('SESSION_NAME', 'onecore_mythos_panel');
...
$csp = "default-src 'none'; style-src 'self'; img-src 'self' data:; font-src 'self'; "
    . "connect-src 'self'; form-action 'self'; frame-ancestors 'none'; base-uri 'none'; object-src 'none'; script-src 'none'";
