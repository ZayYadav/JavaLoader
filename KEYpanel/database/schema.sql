...
CREATE TABLE IF NOT EXISTS modname (
    id TINYINT UNSIGNED NOT NULL,
    modname VARCHAR(100) NOT NULL DEFAULT 'OneCore MyThos',
    PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `_ftext` (
    ...
    `_ftext` VARCHAR(255) NOT NULL DEFAULT 'OneCore MyThos',
    PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO modname (id,modname) VALUES (1,'OneCore MyThos') ON DUPLICATE KEY UPDATE id=VALUES(id);
INSERT INTO `_ftext` (id,`_status`,`_ftext`) VALUES (1,'on','OneCore MyThos') ON DUPLICATE KEY UPDATE id=VALUES(id);
